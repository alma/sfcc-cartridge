 ...
 * @returns {Object} with the properties translated
 */
function getCreditInfo(plan) {
    var costOfCredit = parseInt(plan.customer_total_cost_amount / 100, 10).toString() + '.' + (plan.customer_total_cost_amount % 100) + '€';
